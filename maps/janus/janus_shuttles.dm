...
/datum/shuttle/autodock/ferry/escape_pod/januspod
	category = /datum/shuttle/autodock/ferry/escape_pod/januspod
...
//Pods
#define janus_ESCAPE_POD(NUMBER) \
/datum/shuttle/autodock/ferry/escape_pod/januspod/escape_pod##NUMBER { \
...
/obj/effect/shuttle_landmark/janus/deck1/exploration_shuttle
	name = "Space near Forth Deck"
	landmark_tag = "nav_deck1_calypso"

/obj/effect/shuttle_landmark/janus/deck2/exploration_shuttle
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_calypso"

/obj/effect/shuttle_landmark/janus/deck3/exploration_shuttle
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_calypso"

/obj/effect/shuttle_landmark/janus/deck4/exploration_shuttle
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_calypso"

/obj/effect/shuttle_landmark/janus/deck5/exploration_shuttle
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_calypso"

/obj/effect/shuttle_landmark/transit/janus/exploration_shuttle
	name = "In transit"
...
/obj/effect/shuttle_landmark/janus/hangar/guppy
	name = "Guppy Hangar"
	landmark_tag = "nav_hangar_guppy"
	base_area = /area/quartermaster/hangar
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/janus/deck1/guppy
	name = "Space near Forth Deck"
	landmark_tag = "nav_deck1_guppy"

/obj/effect/shuttle_landmark/janus/deck2/guppy
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_guppy"

/obj/effect/shuttle_landmark/janus/deck3/guppy
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_guppy"

/obj/effect/shuttle_landmark/janus/deck4/guppy
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_guppy"

/obj/effect/shuttle_landmark/janus/deck5/guppy
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_guppy"

/obj/effect/shuttle_landmark/transit/janus/guppy
	name = "In transit"
...
/obj/effect/shuttle_landmark/janus/deck1/aquila
	name = "Space near Forth Deck"
	landmark_tag = "nav_deck1_aquila"

/obj/effect/shuttle_landmark/janus/deck2/aquila
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_aquila"

/obj/effect/shuttle_landmark/janus/deck3/aquila
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_aquila"

/obj/effect/shuttle_landmark/janus/deck4/aquila
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_aquila"

/obj/effect/shuttle_landmark/janus/deck5/aquila
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_aquila"

/obj/effect/shuttle_landmark/transit/janus/aquila
	name = "In transit"
