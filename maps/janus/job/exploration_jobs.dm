/datum/job/pathfinder
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/exploration/pathfinder
...
/datum/job/nt_pilot
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/passenger/pilot
	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/janus/crew/exploration/pilot,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/exploration/pilot/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/janus/passenger/research/nt_pilot,
...
/datum/job/explorer
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/exploration/explorer
	allowed_branches = list(/datum/mil_branch/expeditionary_corps)
