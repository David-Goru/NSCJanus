/datum/job/senior_engineer
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/engineering/senior_engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/engineering/senior_engineer/fleet
	)
	allowed_ranks = list(
...
/datum/job/engineer
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/engineering/engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/engineering/engineer/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/janus/crew/engineering/contractor
	)
	allowed_ranks = list(
...
/datum/job/roboticist
	...
	alt_titles = list(
		"Mechsuit Technician")
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/engineering/roboticist
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/janus/crew/engineering/roboticistec,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/engineering/roboticistfleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/janus/crew/engineering/roboticist
	)
	allowed_ranks = list(
		/datum/mil_rank/fleet/e5,
		/datum/mil_rank/ec/e5,
