/datum/job/qm
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/supply/deckofficer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/supply/deckofficer/fleet
	)
	allowed_ranks = list(
...
/datum/job/cargo_tech
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/supply/tech
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/supply/tech/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/janus/crew/supply/contractor
	)
	allowed_ranks = list(
...
/datum/job/mining
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/passenger/research/prospector
