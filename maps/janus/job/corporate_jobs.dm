/datum/job/liaison
	...
	alt_titles = list(
		"Corporate Liaison",
		"Union Representative" = /decl/hierarchy/outfit/job/janus/passenger/workplace_liaison/union_rep,
		"Corporate Representative",
		"Corporate Executive"
		)
	outfit_type = /decl/hierarchy/outfit/job/janus/passenger/workplace_liaison
...
/datum/job/bodyguard
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/passenger/corporate_bodyguard
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
	...
	alt_titles = list(
		"Union Enforcer" = /decl/hierarchy/outfit/job/janus/passenger/corporate_bodyguard/union,
		"Executive Assistant",
