/datum/job/senior_doctor
	...
	alt_titles = list(
		"Surgeon",
		"Resident")
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/medical/senior
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/medical/senior/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/janus/crew/medical/contractor/senior
	)
	allowed_ranks = list(
...
/datum/job/doctor
	...
	alt_titles = list(
		"Paramedic",
		"Corpsman")
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/medical/doctor
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/medical/doctor/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/janus/crew/medical/contractor
	)
	allowed_ranks = list(
...
/datum/job/chemist
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/medical/contractor/chemist
...
/datum/job/psychiatrist
	...
	minimal_player_age = 0
	supervisors = "the Chief Medical Officer"
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/medical/counselor
	alt_titles = list(
		"Psychiatrist",
		"Psionic Counselor" = /decl/hierarchy/outfit/job/janus/crew/medical/counselor/mentalist,
		"Mentalist" = /decl/hierarchy/outfit/job/janus/crew/medical/counselor/mentalist

	)

	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/expeditionary_corps = /decl/hierarchy/outfit/job/janus/crew/medical/counselor/ec,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/medical/counselor/fleet)
	allowed_ranks = list(
		/datum/mil_rank/civ/contractor,
		/datum/mil_rank/fleet/o1,
		/datum/mil_rank/ec/o1)
