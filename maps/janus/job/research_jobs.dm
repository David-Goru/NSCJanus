/datum/job/senior_scientist
	...
	alt_titles = list(
		"Research Supervisor")
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/research/senior_scientist
...
/datum/job/scientist
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/research/scientist
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
	...
	allowed_ranks = list(,
		/datum/mil_rank/ec/o1,
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/janus/passenger/research/scientist,
		/datum/mil_rank/sol/scientist = /decl/hierarchy/outfit/job/janus/passenger/research/scientist/solgov
	)
...
/datum/job/scientist_assistant
	...
	alt_titles = list(
		"Custodian" = /decl/hierarchy/outfit/job/janus/passenger/research/assist/janitor,
		"Testing Assistant" = /decl/hierarchy/outfit/job/janus/passenger/research/assist/testsubject,
		"Intern",
		"Clerk",
		"Field Assistant")

	outfit_type = /decl/hierarchy/outfit/job/janus/crew/research
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/civilian,
		/datum/mil_branch/solgov
	...
	allowed_ranks = list(
		...
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/janus/passenger/research/assist,
		/datum/mil_rank/sol/scientist = /decl/hierarchy/outfit/job/janus/passenger/research/assist/solgov
	)
	max_skill = list(   SKILL_ANATOMY     = SKILL_MAX,
	                    SKILL_DEVICES     = SKILL_MAX,
	                    SKILL_SCIENCE     = SKILL_MAX)
