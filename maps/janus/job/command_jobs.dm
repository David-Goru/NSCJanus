/datum/job/captain
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/CO
...
/datum/job/hop
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/XO
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/command/XO/fleet
	)
	allowed_ranks = list(
...
/datum/job/rd
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/research/cso
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps
	)
	allowed_ranks = list(
...
/datum/job/cmo
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/cmo
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/command/cmo/fleet
	)
	allowed_ranks = list(
...
/datum/job/chief_engineer
	...
	minimal_player_age = 14
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/chief_engineer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/command/chief_engineer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o3,
...
/datum/job/hos
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/cos
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/command/cos/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ec/o3,
		/datum/mil_rank/fleet/o2,
...
/datum/job/representative
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/representative
...
/datum/job/sea
	...
	minimum_character_age = list(SPECIES_HUMAN = 35)
	ideal_character_age = 45
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/sea/fleet
	allowed_branches = list(
...
/datum/job/bridgeofficer
	...
	outfit_type = /decl/hierarchy/outfit/job/janus/crew/command/bridgeofficer
	allowed_branches = list(
		/datum/mil_branch/expeditionary_corps,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/janus/crew/command/bridgeofficer/fleet
	)
	allowed_ranks = list(
...
/datum/job/bridgeofficer/get_description_blurb()
	return "You are a Bridge Officer. You are a very junior officer. You do not give orders of your own. You are subordinate to all of command. You handle matters on the bridge and report directly to the CO and XO. You take the janus's helm and pilot the Aquila if needed. You monitor bridge computer programs and communications and report relevant information to command."
