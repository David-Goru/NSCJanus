 ...
 * janus Service
 */
/decl/closet_appearance/secure_closet/janus/hydroponics
	extra_decals = list(
...
/obj/structure/closet/chefcloset_janus
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/black

/obj/structure/closet/chefcloset_janus/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_janus //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/janus/hydroponics

/obj/structure/closet/secure_closet/hydroponics_janus/WillContain()
	return list(
...
/obj/structure/closet/jcloset_janus
	name = "custodial closet"
	desc = "It's a storage unit for janitorial equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/mixed

/obj/structure/closet/jcloset_janus/WillContain()
	return list(
