...
/decl/closet_appearance/secure_closet/janus/engineering
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_WARM_YELLOW,
		"exped" = COLOR_WARM_YELLOW
	)

/decl/closet_appearance/secure_closet/janus/engineering/atmos
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/janus/engineering/se
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/janus/engineering/ce
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_WARM_YELLOW,
...
/obj/structure/closet/secure_closet/engineering_chief_janus
	name = "chief engineer's locker"
	req_access = list(access_ce)
	closet_appearance = /decl/closet_appearance/secure_closet/janus/engineering/ce

/obj/structure/closet/secure_closet/engineering_chief_janus/WillContain()
	return list(
