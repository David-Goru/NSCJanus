...
/decl/closet_appearance/secure_closet/janus/security
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_NT_RED,
		"security" = COLOR_NT_RED
	)

/decl/closet_appearance/secure_closet/janus/security/forensics
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_NT_RED,
		"forensics" = COLOR_NT_RED
	)

/decl/closet_appearance/secure_closet/janus/security/warden
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/janus/security/hos
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_NT_RED,
