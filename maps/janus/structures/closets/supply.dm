 ...
 * janus Supply
 */
/decl/closet_appearance/secure_closet/janus/cargo
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_BEASTY_BROWN,
		"cargo_upper" = COLOR_BEASTY_BROWN
	)

/decl/closet_appearance/secure_closet/janus/cargo/worker
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/janus/cargo/deck_officer
	extra_decals = list(
...
/obj/structure/closet/secure_closet/prospector
	...
	closet_appearance = /decl/closet_appearance/secure_closet/janus/cargo
