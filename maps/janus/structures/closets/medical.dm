 ...
 * janus Medical
 */
/decl/closet_appearance/secure_closet/janus/medical
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_BABY_BLUE,
		"medical" = COLOR_BABY_BLUE
	)

/decl/closet_appearance/secure_closet/janus/medical/physician
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/janus/medical/cmo
	extra_decals = list(
		"stripe_vertical_left_full" = COLOR_BABY_BLUE,
...
/obj/structure/closet/wardrobe/medic_janus
	name = "medical wardrobe"
	closet_appearance = /decl/closet_appearance/wardrobe/white

/obj/structure/closet/wardrobe/medic_janus/WillContain()
	return list(
