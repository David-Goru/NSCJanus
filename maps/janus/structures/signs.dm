/obj/structure/sign/dedicationplaque
	name = "\improper SEV janus dedication plaque"
	icon_state = "lightplaque"

/obj/structure/sign/dedicationplaque/Initialize()
	. = ..()
	desc = "S.E.V. janus - Mako Class - Sol Expeditionary Corps Registry 95519 - Shiva Fleet Yards, Mars - First Vessel To Bear The Name - Launched [game_year-5] - Sol Central Government - 'Never was anything great achieved without danger.'"
...
/obj/structure/sign/ecplaque
	...
	icon = 'maps/janus/icons/obj/solgov-decals.dmi'
	icon_state = "ecplaque"
...
/obj/effect/floor_decal/scglogo
	alpha = 230
	icon = 'maps/janus/icons/obj/solgov_floor.dmi'
	icon_state = "center"
