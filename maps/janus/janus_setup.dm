/datum/map/janus/setup_map()
	..()
	system_name = generate_system_name()
	minor_announcement = new(new_sound = sound('sound/AI/janus/commandreport.ogg', volume = 45))

/datum/map/janus/get_map_info()
	. = list()
...
/datum/map/janus/send_welcome()
	var/welcome_text = "<center><img src = sollogo.png /><br /><font size = 3><b>SEV janus</b> Sensor Readings:</font><br>"
	welcome_text += "Report generated on [stationdate2text()] at [stationtime2text()]</center><br /><br />"
	welcome_text += "<hr>Current system:<br /><b>[system_name()]</b><br /><br>"

	var/list/space_things = list()
	var/obj/effect/overmap/visitable/janus = map_sectors["1"]

	welcome_text += "Current Coordinates:<br /><b>[janus.x]:[janus.y]</b><br /><br>"
	...
	for(var/obj/effect/overmap/visitable/O in space_things)
		...
		if(O.loc != janus.loc)
			var/bearing = round(90 - Atan2(O.x - janus.x, O.y - janus.y),5) //fucking triangles how do they work
			if(bearing < 0)
				bearing += 360
	...
	post_comm_message("NSC Janus Sensor Readings", welcome_text)
