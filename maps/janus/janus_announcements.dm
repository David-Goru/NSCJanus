/datum/map/janus
	...
	emergency_shuttle_called_sound = sound('sound/AI/janus/abandonship.ogg', volume = 45)

	emergency_shuttle_recall_message = "Attention all hands: emergency evacuation sequence aborted. Return to normal operating conditions."

	command_report_sound = sound('sound/AI/janus/commandreport.ogg', volume = 45)
	...
	grid_check_sound = sound('sound/AI/janus/poweroff.ogg', volume = 45)

	grid_restored_message = "Ship power to the %STATION_NAME% will be restored at this time"
	grid_restored_sound = sound('sound/AI/janus/poweron.ogg', volume = 45)

	meteor_detected_sound = sound('sound/AI/janus/meteors.ogg', volume = 45)
	...
	radiation_detected_sound = sound('sound/AI/janus/radiation.ogg', volume = 45)

	space_time_anomaly_sound = sound('sound/AI/janus/spanomalies.ogg', volume = 45)
	...
	unidentified_lifesigns_sound = sound('sound/AI/janus/aliens.ogg', volume = 45)

	lifesign_spawn_sound = sound('sound/AI/janus/aliens.ogg', volume = 45)

	electrical_storm_moderate_sound = sound('sound/AI/janus/electricalstormmoderate.ogg', volume = 45)
	electrical_storm_major_sound = sound('sound/AI/janus/electricalstormmajor.ogg', volume = 45)

/datum/map/janus/level_x_biohazard_sound(var/bio_level)
	switch(bio_level)
		if(7)
			return sound('sound/AI/janus/outbreak7.ogg', volume = 45)
		else
			return sound('sound/AI/janus/outbreak5.ogg', volume = 45)
