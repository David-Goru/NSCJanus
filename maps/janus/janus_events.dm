...
/datum/map/janus/setup_events()
	map_event_container = list(
				num2text(EVENT_LEVEL_MODERATE)	= new/datum/event_container/moderate/janus,
				num2text(EVENT_LEVEL_MAJOR) 	= new/datum/event_container/major/janus
			)
...
/datum/event_container/moderate/janus
...
/datum/event_container/major/janus
	available_events = list(
