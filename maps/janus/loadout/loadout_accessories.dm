...
/datum/gear/accessory/janus_patch
	display_name = "janus mission patch"
	path = /obj/item/clothing/accessory/solgov/janus_patch
	description = "A shoulder patch representing the SEV janus and its mission. Given to all the oddjobs pulled from various branches to work on the janus."
