...
/obj/item/weapon/rig/command
	...
	icon = 'maps/janus/icons/obj/uniques.dmi'
...
/obj/item/clothing/shoes/magboots/rig/command
	icon = 'maps/janus/icons/obj/obj_feet_solgov.dmi'
	item_icons = list(slot_shoes_str = 'maps/janus/icons/mob/onmob_feet_solgov.dmi')
	species_restricted = list(SPECIES_HUMAN,SPECIES_IPC)

/obj/item/clothing/gloves/rig/command
	icon = 'maps/janus/icons/obj/obj_hands_solgov.dmi'
	item_icons = list(slot_gloves_str = 'maps/janus/icons/mob/onmob_hands_solgov.dmi')
	species_restricted = list(SPECIES_HUMAN,SPECIES_IPC)
