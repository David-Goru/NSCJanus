...
/obj/item/weapon/folder/envelope/captain
	desc = "A thick envelope. The SCG crest is stamped in the corner, along with 'TOP SECRET - janus UMBRA'."
...
/obj/item/weapon/folder/envelope/captain/LateInitialize()
	..()
	var/obj/effect/overmap/visitable/janus = map_sectors["[z]"]
	var/memo = {"
	<tt><center><b><font color='red'>SECRET - CODE WORDS: janus</font></b>
	<h3>SOL CENTRAL GOVERNMENT EXPEDITIONARY COMMAND</h3>
	<img src = sollogo.png>
	</center>
	<b>FROM:</b> ADM William Lau<br>
	<b>TO:</b> Commanding Officer of SEV janus<br>
	...
	The current docking code is: [janus.docking_codes]<br>
...
/obj/item/weapon/paper/umbra
	name = "UMBRA Protocol"
	info = {"
	<tt><center><b><font color='red'>TOP SECRET - CODE WORDS: janus UMBRA</font></b>
	...
	<b>TO:</b> Commanding Officer of the SEV janus<br>
	<b>CC:</b> Special Representative aboard the SEV janus<br>
	...
	<li>Information about this expedition's findings is to be treated as secret and vital to SCG's national security, and is protected under codeword UMBRA. Only SCG government employees and Skrell citizens aboard the SEV janus are allowed access to this information on a need-to-know basis.</li>
