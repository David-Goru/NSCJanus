/obj/item/clothing/suit/storage/solgov/
	...
	icon = 'maps/janus/icons/obj/obj_suit_solgov.dmi'
	item_icons = list(slot_wear_suit_str = 'maps/janus/icons/mob/onmob_suit_solgov.dmi')
...
/obj/item/clothing/suit/space/void/engineering/alt/sol
	...
	item_icons = list(slot_wear_suit_str = 'maps/janus/icons/mob/onmob_suit_solgov.dmi')
	sprite_sheets = list(
		SPECIES_UNATHI = 'maps/janus/icons/mob/unathi/onmob_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'maps/janus/icons/mob/skrell/onmob_suit_solgov_skrell.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'maps/janus/icons/obj/unathi/obj_suit_solgov_unathi.dmi',
		SPECIES_SKRELL = 'maps/janus/icons/obj/skrell/obj_suit_solgov_skrell.dmi',
		)
...
/obj/item/clothing/head/helmet/space/void/command
	icon = 'maps/janus/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/janus/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/helmet/space/void/exploration
	...
	sprite_sheets = list(
		SPECIES_SKRELL = 'maps/janus/icons/mob/skrell/onmob_head_solgov_skrell.dmi'
		)
	sprite_sheets_obj = list()
	armor = list(
