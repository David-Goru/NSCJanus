/obj/item/clothing/accessory/solgov
	...
	icon = 'maps/janus/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/janus/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'maps/janus/icons/mob/onmob_accessories_solgov.dmi')
...
/obj/item/clothing/accessory/solgov/janus_patch
	name = "\improper janus mission patch"
	desc = "A fire resistant shoulder patch, worn by the personnel involved in the janus Project."
	icon_state = "januspatch"
...
/obj/item/clothing/accessory/armor/tag/solgov
	...
	icon_override = 'maps/janus/icons/obj/obj_accessories_solgov.dmi'
	icon = 'maps/janus/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/janus/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'maps/janus/icons/mob/onmob_accessories_solgov.dmi')
	icon_state = "solflag"
