...
/obj/item/clothing/head/helmet/space/void/engineering/alt/sol
	...
	item_icons = list(slot_head_str = 'maps/janus/icons/mob/onmob_head_solgov.dmi')
	sprite_sheets = list(
		SPECIES_UNATHI = 'maps/janus/icons/mob/unathi/onmob_head_solgov_unathi.dmi',
		SPECIES_SKRELL = 'maps/janus/icons/mob/skrell/onmob_head_solgov_skrell.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'maps/janus/icons/obj/unathi/obj_head_solgov_unathi.dmi',
		SPECIES_SKRELL = 'maps/janus/icons/obj/skrell/obj_head_solgov_skrell.dmi',
		)
