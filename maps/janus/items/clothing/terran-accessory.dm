...
/obj/item/clothing/accessory/terran/rank/navy
	...
	icon = 'maps/janus/icons/obj/obj_accessories_terran.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/janus/icons/mob/onmob_accessories_terran.dmi', slot_wear_suit_str = 'maps/janus/icons/mob/onmob_accessories_terran.dmi')
