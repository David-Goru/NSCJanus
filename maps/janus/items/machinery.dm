//Shouldn't be a lot in here, only janus versions of existing machines that need a different access req or something along those lines.

/obj/machinery/vending/medical/janus
	req_access = list(access_medical)

/obj/machinery/drone_fabricator/janus
	fabricator_tag = "SEV janus Maintenance"

/obj/machinery/drone_fabricator/janus/adv
	name = "advanced drone fabricator"
	fabricator_tag = "SFV Arrow Maintenance"
	drone_type = /mob/living/silicon/robot/drone/construction

//telecommunications gubbins for janus-specific networks
