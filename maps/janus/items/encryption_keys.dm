/obj/item/device/encryptionkey/heads/janusexec
...
/obj/item/device/encryptionkey/headset_janusnt
	name = "corporate radio encryption key"
	icon_state = "nt_cypherkey"
	channels = list("Science" = 1)

/obj/item/device/encryptionkey/headset_janusrd
	name = "chief science officer radio encryption key"
	icon_state = "nt_cypherkey"
	channels = list("Science" = 1, "Command" = 1, "Exploration" = 1)

/obj/item/device/encryptionkey/headset_januscorp
	name = "corporate radio encryption key"
	icon_state = "nt_cypherkey"
	channels = list("Science" = 1, "Service" = 1)

/obj/item/device/encryptionkey/headset_januscl
