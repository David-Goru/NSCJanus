...
/obj/machinery/station_map/Initialize()
	...
	small_station_map.layer = MIMICED_LIGHTING_LAYER
...
/obj/machinery/station_map/update_icon()
	...
	if(stat & BROKEN)
		...
		if(bogus)
			...
			new_overlays += small_station_map
	...
	if(floor_markings)
		...
		new_overlays += floor_markings

	if(panel_open)
		new_overlays += "station_map-panel"

	new_overlays += holomap_datum.cursor
	new_overlays += holomap_datum.legend
