...
/obj/item/toy/janusmodel
	name = "table-top SEV janus model"
	desc = "This is a replica of the SEV janus, in 1:250th scale, on a handsome wooden stand. Small lights blink on the hull and at the engine exhaust."
	icon = 'icons/obj/toy.dmi'
	icon_state = "janus_model_figure"
