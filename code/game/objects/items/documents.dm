...
/obj/item/documents/nanotrasen
	...
	desc = "\"Top Secret\" corporate documents, filled with complex diagrams, research procedures, and details on cloning or breeding rights to non-sapient species the janus encounters. It seems like they will be auctioning them off to the highest private bidder."
...
/obj/item/documents/scg/verified
	...
	desc = "\"Top Secret\" documents detailing SCG IFF codes, granting the janus access into restricted sectors. The majority of them are coordinates, codes for fellow ships, and clearance lists."
...
/obj/item/documents/scg/blue
	...
	desc = "\"Top Secret\" documents detailing the Skrellian company Krri'gli, and their insistent requests upon specific priority sectors for the janus to investigate."
	description_antag = "Krri'gli seem to be guiding the janus, subtly, to a specific unmapped sector of the galaxy. It's almost like they're too afraid to investigate it personally."
