...
/obj/machinery/navbeacon/janus/bridge2
	location = "bridge2"
	codes = list("patrol" = 1, "next_patrol" = "rdoffice")

/obj/machinery/navbeacon/janus/vault2
	location = "vault2"
	codes = list("patrol" = 1, "next_patrol" = "medical")

/obj/machinery/navbeacon/janus/vault1
	location = "vault1"
	codes = list("patrol" = 1, "next_patrol" = "xooffice")

/obj/machinery/navbeacon/janus/medical
	location = "medical"
...
/obj/machinery/navbeacon/janus/rdoffice
	location = "rdoffice"
	codes = list("patrol" = 1, "next_patrol" = "vault2")

// janus delivery types

/obj/machinery/navbeacon/janus/QM3
	location = "QM #3"
