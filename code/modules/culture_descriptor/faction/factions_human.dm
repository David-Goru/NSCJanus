...
/decl/cultural_info/faction/janusco
	...
	backers who asssisted in funding the janus project when it opened five years ago. Major players include NanoTrasen, Xynergy and \
...
/decl/cultural_info/faction/dais
	...
	few corporate members of the Solar Assembly. DAIS is also a major investor in the janus project, and is on the Expeditionary Corps Organization board of directors. \
