/mob/new_player/Login()
	...
	if(join_motd)
		to_chat(src, "<br><div class=\"motd\">[join_motd]</div><br>")
...
/mob/new_player/proc/deferred_login()
	...
	to_chat(src, "<br><span class='notice'>The alert level on the [station_name()] is currently: <font color=[SL.light_color_alarm]><B>[SL.name]</B></font>. [alert_desc]</span><br>")