SUBSYSTEM_DEF(ticker)
	...
	var/start_ASAP = TRUE			// Enabled for speed up testing
	...
	var/datum/game_mode/mode = "extended"
...
/datum/controller/subsystem/ticker/proc/setup_tick()
	...
	var/datum/game_mode/mode_datum = config.pick_mode(master_mode)
	...
	spawn(0)//Forking here so we dont have to wait for this to finish
		...
		to_world("<FONT color=#99b3ff><B>Enjoy the game!</B></FONT><br>")
